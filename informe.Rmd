...
Resulta extraño que todas las personas encuestadas manifiestan tener ingresos que refieren al quinto quintil.  Se hizo una consulta al area de Estadísticas del Gobierno de la Ciudad de Buenos Aires y admitieron el error. 
...
En cuanto a la distribución general, la relación entre rango etario y promedio de horas destinadas a las tareas de cuidado se visualiza en forma más clara para las personas entre 25 y 39 años. Este intervalo etario se corresponde en la edad más comun para tener hijes (ver estadistica en ciudad).  Se presenta a continuación la información diferennciada por sexo. 
...
Para las mujeres, las edades (....)
Se presenta a continuación de los varones
...
mismas relaciones trabajo domestico
...
Respecto a la relación entre las horas trabajadas para el mercado laboral y las horas destinadas a las tareas de cuidado, ¿las mujeres que trabajan mayor cantidad de hs en el mercado destinan menor cantidad de hs a a las tareas de cuidado de personas que las que trabajan menos horas?  ¿Esta relación se mantiene para el caso de los varones? ¿y respecto a las tareas de cuidado de hogar?
```{r}
...
usodeltiempo |> 
filter(sexo== "Mujer")  |> 
  ggplot(aes(trabajo_pago, trabajo_domestico_no_pago)) +
  geom_point()
