...
Según lo presentado en los párrafos anteriores, la encuesta de uso del tiempo se implementa con el propósito de conocer la distribución de las tareas de cuidado al interior de los hogares.  Asismismo se reitera que este relevamiento se llevo a cabo en la Ciudad Autónoma de Buenos Aires en el año 2016 y se toma como unidad de medida las horas requeridas para llevar a cabo tales tareas. En virtud de ello, se presenta a continuación algunos datos que permiten conocer dicha distribución:
...
Conforme a la información precedente, se observa que la abrumdora mayoria de observaciones están en el valor "0", lo que redunda en una significativa reducción del promedio.  Esta situación puede deberse a que no se tiene el dato;  o bien que la persona respondió que no le dedica horas a las tareas de cuidados. Frente a esta situación,  una alternativa posible es tomar los datos mayores a ese valor para observar si se obtiene un resultado diferente:
...
El tabulado anterior expresa información más acertada en relación a la distribución de las tareas de cuidado.  En efecto, en promedio las mujeres destinan mayor carga horaria en las tareas de cuidado de personas, 5,8  frente a 3,7 horas de los varones. 
No obstante, se reiterar la aclaración  que no fueron tenidos en cuenta los casos que tienen valor "0" en esa variable y que dichos casos  representan 1801 de 2336 observaciones, reduciendo considerablemente la muestra tomada.  
Por ello, resulta importante complementar la información obtenida con otros análisis para tener una mirada de mayor integralidad. 
...
Se si analizan los datos vinculados a la carga horaria destinada a labores de voluntarias y las de trabajo remunerado se obtiene la siguiente información:
...
Tanto en las hs destinadas al trabajo remunerado como a las actividades voluntarias, se observa nuevamente la mayoria de observaciones bajo el valor cero.  Por ello, se toma la misma decisión anteriormente expresada. 
...
```
De acuerdo a la información precedente,  no se observan diferencias significativas en relación a la distribución por sexo. 
