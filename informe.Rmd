...
Si se toman la cantidad de horas dedidacas al trabajo doméstico no pago según sexo, se visualiza la siguiente relación:
...
```
En este caso en el dataset, no figuran tantos valores en "0" como en el caso anterior, por eso se mantiene. Conforme a la información anterior, en relación al tiempo promedio dedicado al trabajo doméstico no remunerado, las mujeres casi duplican la cantidad de horas en relación a los varones. 
A continuación, se presenta información adicional a la distribución horaria. 
...
La brecha en la distribución de las tareas de cuidado en relación al sexo se redujo en los últimos diez años? (se prevee tomar en cuenta el dataset de 2005)


Las mujeres que trabajan mayor cantidad de hs en el mercado destinan menor cantidad de hs a a las tareas de cuidado que las que trabajan menos horas?  Esta relación se mantiene para el caso de los varones?
